class ApiConstants {
  // 10.0.2.2 = adresse spéciale de l'émulateur Android pour atteindre
  // le "localhost" de la machine hôte (ton PC Windows).
  static const String walletBaseUrl = 'http://10.0.2.2:8080';
  static const String paymentBaseUrl = 'http://10.0.2.2:8081';
